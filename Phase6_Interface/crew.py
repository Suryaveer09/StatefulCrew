# ─────────────────────────────────────────────────────────────────
# Phase 6: Streamlit-ready crew module — importable via build_graph(),
# with every node using sanitized context, graceful handling of
# unanswerable questions, and an iteration guardrail that always
# guarantees a real written answer instead of a raw dump.
# ─────────────────────────────────────────────────────────────────
